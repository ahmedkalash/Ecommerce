        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    ...
                    <br>
                    <a href="{{ route('preorder-product.details', $conversation->preorderProduct->product_slug) }}"
                       class="btn btn-link btn-sm px-0 fs-14" target="_blank">
                        ...
                        <li class="list-group-item px-0">
                            <div class="media mb-2">
                                <img class="avatar avatar-xs mr-3"
                                     @if($message->sender != null) src="{{ get_file_by_id($message->sender->avatar_original) }}"
