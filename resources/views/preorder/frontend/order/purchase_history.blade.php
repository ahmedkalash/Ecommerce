                ...
                @foreach ($orders as $key => $order)
                    ...
                    <tr class="align-middle text-center">
                        ...
                        <td class="pl-0 d-flex align-items-center">
                            <div class="col-auto">
                                <img src="{{ get_file_by_id($order->preorder_product?->thumbnail) }}" alt="Image"
                        ...
                        <td class="text-right pr-0 align-middle">
                            <!-- Details -->
                            <a href="{{ route('preorder.order_details', encrypt($order->id)) }}"
                               ...
                               title="{{ translate('Order Details') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10">
                                    <g id="Group_24807" data-name="Group 24807" transform="translate(-1339 -422)">
                                        <rect id="Rectangle_18658" data-name="Rectangle 18658" width="12" height="1"
                                              transform="translate(1339 422)" fill="#3490f3"/>
                                        <rect id="Rectangle_18659" data-name="Rectangle 18659" width="12" height="1"
                                              transform="translate(1339 425)" fill="#3490f3"/>
                                        <rect id="Rectangle_18660" data-name="Rectangle 18660" width="12" height="1"
