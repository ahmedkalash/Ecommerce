                    ...
                    <div class="col-md-8 mb-4">
                        ...
                        <div class="d-flex">
                            <div class="my-2">
                                <a href="{{ $order->preorder_product != null ? (route('preorder-product.details',$order->preorder_product?->product_slug)) : '#' }}">
                                    <img src="{{get_file_by_id($order->preorder_product?->thumbnail)}}"
                                         alt="product image" class="h-100px border rounded-2">
                                </a>
                            </div>
                            <div class="my-2 ml-4">
                                <a href="{{ $order->preorder_product != null ? (route('preorder-product.details',$order->preorder_product?->product_slug)) : '#' }}"
                                   class="text-black" style="color: initial;"><p
                                        class="fw-700 mt-2 break-word">{{$order->preorder_product?->product_name}}</p>
                                </a>
                                <div class="row mt-2">
                                    <div class="col-auto m-0">
                                    <span
                                        class="badge badge-inline badge-info fs-12 fw-700 p-3 text-white m-1 rounded-2"
                                    >{{translate('Order Code : '. $order->order_code)}}</span>
                                        <span
                                            class="badge badge-inline badge-cool-blue fs-12 fw-700 p-3 text-white m-1 rounded-2"
                                        ...
                                        @if($order->preorder_product?->discount != null && $order->preorder_product?->discount > 0 && $order->preorder_product?->discount_start_date != null && (strtotime(date('d-m-Y')) > $order->preorder_product->discount_start_date || strtotime(date('d-m-Y')) < $order->preorder_product->discount_end_date))
                                            <span
                                                class="badge badge-inline badge-orange fs-12 fw-700 p-3 text-white m-1 rounded-2"
                                        ...
                                        @if($order->preorder_product?->is_prepayment)
                                            <span
                                                class="badge badge-inline badge-sea-green fs-12 fw-700 p-3 text-white m-1 rounded-2"
                        ...
                        <div class="accordion mt-4" id="accordioncCheckoutInfo">
                            ...
                            <div class="card rounded-0 border shadow-none"
                                 style="margin-bottom: 2rem; border-radius: 0.5rem !important;">
                                <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingPreorderRequest"
                                     type="button" data-toggle="collapse" data-target="#collapsePreorderRequest"
                                     aria-expanded="true" aria-controls="collapsePreorderRequest">
                                ...
                                <div id="collapsePreorderRequest" class="collapse show"
                                     aria-labelledby="headingPreorderRequest" data-parent="#accordioncCheckoutInfo">
                                        ...
                                        <form action="{{route('preorder.order_update',$order->id)}}" method="POST">
                                            ...
                                            <div>
                                                @if($order->preorder_product?->is_cod)
                                                    <p><i class="las la-arrow-right"></i>
                                                        <span
                                                            class="ml-2">{{translate('Cash ondelivery available')}}</span>
                                                    </p>
                                                @endif
                                            ...
                                            @if($order->request_note != null)
                                                <div>
                                                    <div class="mt-4">
                                                        <p class="border p-2"
                                                           style="font-style: italic;"> {{ $order->request_note }}</p>
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            <div>
                                                @if($order->request_preorder_status == 2)
                                                    <div class="col-12 m-0 p-0">
                                                        <button type="submit" class="btn btn-block btn-success fs-16"
                                                                disabled><i
                                                                class="las la-check-circle"></i> {{ translate(' Accepted')  }}
                                                        </button>
                                                    </div>
                                                ...
                                                @elseif($order->request_preorder_status == 1)
                                                    <div class="col-12 m-0 p-0">
                                                        <button type="submit" class="btn btn-block btn-secondary "
                                                                disabled>{{  translate('Requested') }}</button>
                                                    </div>
                                                @else
                                                    <div class="col-12 m-0 p-0">
                                                        <button type="submit"
                                                                class="btn btn-block btn-soft-primary ">{{  translate('Request')  }}</button>
                                                    </div>
                                                @endif
                                            </div>
                                        </form>
                            ...
                            @if($order->preorder_product?->is_prepayment)
                                <div class="card rounded-0 border shadow-none"
                                    ...
                                    <div class="card-header border-bottom-0 py-3 py-xl-4"
                                         id="headingPrepaymentConfirmation" type="button" data-toggle="collapse"
                                         data-target="#collapsePrepaymentConfirmation" aria-expanded="true"
                                         aria-controls="collapsePrepaymentConfirmation">
                                        <div class="d-flex align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                 viewBox="0 0 20 20">
                                                <path id="Path_42357" data-name="Path 42357"
                                                      d="M58,48A10,10,0,1,0,68,58,10,10,0,0,0,58,48ZM56.457,61.543a.663.663,0,0,1-.423.212.693.693,0,0,1-.428-.216l-2.692-2.692.856-.856,2.269,2.269,6-6.043.841.87Z"
                                                      transform="translate(-48 -48)"
                                                      fill="{{ preorder_fill_color($order->prepayment_confirm_status,  $order->request_preorder_status) }}"/>
                                            </svg>
                                            <span
                                                class="ml-2 fs-19 fw-700">{{ translate('Pre-payment & Confirmation') }}</span>
                                        </div>
                                        <i class="las la-angle-down fs-18"></i>
                                    </div>
                                    <div id="collapsePrepaymentConfirmation" class="collapse "
                                         aria-labelledby="headingPrepaymentConfirmation"
                                        ...
                                        <div class="card-body" id="shipping_info">
                                            <form action="{{route('preorder.order_update',$order->id)}}" method="POST">
                                                    ...
                                                    @if($instruction_qr_code)
                                                        <div class="mb-3">
                                                            <img class="w-120px h-120px"
                                                                 src="{{ get_file_by_id($instruction_qr_code) }}"
                                                                 alt="">
                                                        </div>
                                                    @endif
                                                </div>
                                                ...
                                                <div
                                                    class="form-section preorder-border-dashed-grey px-4 py-2 rounded-2">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           @if($order->prepayment_confirm_status !== 0) readonly @endif>
                                                            ...
                                                            <div class="col d-flex justify-content-between">
                                                                ...
                                                                <div class="ml-4">
                                                                    <p><img class="w-50px h-50px"
                                                                            src="{{ get_file_by_id($order->payment_proof) }}"
                                                                            alt=""></p>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            @if($order->confirm_note != null)
                                                                <div>
                                                                    <div class="mt-4">
                                                                        <p class="border p-2"
                                                                           style="font-style: italic;"> {{ $order->confirm_note }}</p>
                                                                    </div>
                                                                </div>
                                                            @endif
                                                        </div>
                                                ...
                                                <div>
                                                    ...
                                                    @if($order->request_preorder_status == 2)
                                                        @if($order->prepayment_confirm_status == 2)
                                                            <div class="col-12 m-0 p-0">
                                                                <button type="submit"
                                                                        class="btn btn-block btn-success fs-16"
                                                                        disabled><i
                                                                        class="las la-check-circle"></i> {{ translate(' Accepted')  }}
                                                                </button>
                                                            </div>
                                                        ...
                                                        @else
                                                            <div class="col-12 m-0 p-0">
                                                                <button type="submit"
                                                                        class="btn btn-block btn-soft-primary " {{$order->request_preorder_status !== 2 ? 'disabled' : ''}}>{{  translate('Request')  }}</button>
                                                            </div>
                                                        @endif
                                                    @endif
                            ...
                            <div class="card rounded-0 border shadow-none"
                                 style="margin-bottom: 2rem; border-radius: 0.5rem !important;">
                                <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingFinalOrder"
                                     type="button" data-toggle="collapse" data-target="#collapseFinalOrder"
                                     aria-expanded="true" aria-controls="collapseFinalOrder">
                                    <div class="d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                             viewBox="0 0 20 20">
                                            <path id="Path_42357" data-name="Path 42357"
                                                  d="M58,48A10,10,0,1,0,68,58,10,10,0,0,0,58,48ZM56.457,61.543a.663.663,0,0,1-.423.212.693.693,0,0,1-.428-.216l-2.692-2.692.856-.856,2.269,2.269,6-6.043.841.87Z"
                                                  transform="translate(-48 -48)"
                                                  fill="{{ preorder_fill_color($order->final_order_status, $order->prepayment_confirm_status) }}"/>
                                        </svg>
                                        <span
                                            class="ml-2 fs-19 fw-700">{{ translate('Final Payment & Order Completion') }}</span>
                                    </div>
                                    <i class="las la-angle-down fs-18"></i>
                                </div>
                                <div id="collapseFinalOrder" class="collapse " aria-labelledby="headingFinalOrder"
                                     data-parent="#accordioncCheckoutInfo">
                                    <div class="card-body" id="shipping_info">
                                        <form action="{{route('preorder.order_update', $order->id)}}" method="POST"
                                            ...
                                            <div class="accordion mt-4" id="nestedAccordion">
                                                ...
                                                <div class="card rounded-0 border shadow-none"
                                                     style="margin-bottom: 2rem; border-radius: 0.5rem !important;">
                                                    <div class="card-header border-bottom-0 py-3 py-xl-4"
                                                         id="nestedAccordionItem1"
                                                         type="button" data-toggle="collapse"
                                                         data-target="#collapsenestedAccordionItem1"
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="ml-2 fs-19 fw-700">{{ translate('Address') }}</span>
                                                        </div>
                                                        <i class="las la-angle-down fs-18"></i>
                                                    </div>
                                                    <div id="collapsenestedAccordionItem1"
                                                         class="collapse p-4 rounded-2"
                                                         aria-labelledby="nestedAccordionItem1"
                                            ...
                                            <div class="card rounded-0 border shadow-none"
                                                ...
                                                <div class="card-header border-bottom-0 py-3 py-xl-4"
                                                     id="headingDeliveryInfo" type="button"
                                                     data-toggle="collapse" data-target="#collapseDeliveryInfo"
                                                     aria-expanded="true"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span
                                                            class="ml-2 fs-19 fw-700">{{ translate('Delivery Info') }}</span>
                                                    </div>
                                                    <i class="las la-angle-down fs-18"></i>
                                                </div>
                                            ...
                                            <div class="card rounded-0 border shadow-none"
                                                 style="margin-bottom: 2rem; overflow: visible !important; border-radius: 0.5rem !important;">
                                                <div class="card-header border-bottom-0 py-3 py-xl-4"
                                                     id="headingPaymentInfo" type="button"
                                                     data-toggle="collapse" data-target="#collapseheadingPaymentInfo"
                                                     aria-expanded="true"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span
                                                            class="ml-2 fs-19 fw-700">{{ translate('Payment Info') }}</span>
                                                    </div>
                                                    <i class="las la-angle-down fs-18"></i>
                                                </div>
                                                <div id="collapseheadingPaymentInfo" class="collapse"
                                                    ...
                                                    <div class="card-body" id="delivery_info">
                                                        ...
                                                        <div
                                                            class="form-section preorder-border-dashed-grey p-4 rounded-2">
                                                            @if($order->final_order_status == 0 && $order->preorder_product?->is_cod)
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-md-6 col-from-label">{{translate('Cash on delivery')}}</label>
                                                                    <div class="col-md-6">
                                                                        <label
                                                                            class="aiz-switch aiz-switch-success mb-0">
                                                                            <input type="checkbox"
                                                                                   name="cod_for_final_order" value="1"
                                                                                   id="final_payment_cash_on_delivery"
                                                                                   onchange="toggleFinalpaymentFields()">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            @if($order->final_order_status == 0)
                                                                <div class="row" id="final_payment_fields">
                                                                    <div class="col-6">
                                                                        <div class="form-group ">
                                                                            <label class="col-form-label"
                                                                                   for="signinSrEmail">{{translate('Proof
                                                                        of payment')}}</label>
                                                                            <div class="input-group"
                                                                                ...
                                                                                @if($order->final_order_status == 0)
                                                                                    ...
                                                                                    <div
                                                                                        class="form-control file-amount">{{ translate('Choose
                                                                            File') }}</div>
                                                                                @endif
                                                                                <input type="hidden"
                                                                                       name="final_payment_proof"
                                                                                       class="selected-files"
                                                                                       value="{{$order->final_payment_proof}}">
                                                                            </div>
                                                                            <div class="file-preview box sm">
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <input type="text"
                                                                                   ...
                                                                                   placeholder="{{ translate('Ref No') }}"
                                                                                   onchange="update_sku()"
                                                                                   value="{{$order->final_payment_reference_no}}"
                                                                                   @if($order->final_order_status !== 0) readonly @endif>
                                                                    ...
                                                                    <div class="col d-flex justify-content-between">
                                                                        <div>
                                                                            @if($order->cod_for_final_order)
                                                                                <p><b>{{translate('Payment Type')}}</b>
                                                                                </p>
                                                                            @else
                                                                                <p>
                                                                                    <b>{{translate('Proof of payment')}}</b>
                                                                                </p>
                                                                                <p><b>{{translate('Reference No.')}}</b>
                                                                                </p>
                                                                            @endif
                                                                        </div>
                                                                        <div class="ml-4">
                                                                            @if($order->cod_for_final_order)
                                                                                <p>
                                                                                    <b>{{translate('Cash on delivery')}}</b>
                                                                                </p>
                                                                            @else
                                                                                <p><img class="w-50px h-50px"
                                                                                        src="{{ get_file_by_id($order->final_payment_proof) }}"
                                                                                        alt=""></p>
                                                                ...
                                                                <div class="col-12">
                                                                    @if($order->final_order_status == 0)
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <textarea name="final_payment_confirm_note"
                                                                                      rows="4"
                                                                                      class="form-control"></textarea>
                                                                        </div>
                                                                    @endif
                                                                    @if($order->final_payment_confirm_note != null)
                                                                        <div>
                                                                            <div class="mt-4">
                                                                                <p class="border p-2"
                                                                                   style="font-style: italic;"> {{ $order->final_payment_confirm_note }}</p>
                                                                            </div>
                                                                        </div>
                                                                    @endif
                                                                </div>
                                            ...
                                            @if($order->final_oder_note)
                                                <div class="col-12">
                                                    <div class="form-group ">
                                                        <label class="col-form-label fw-700"
                                                               for="signinSrEmail">{{translate('Note From Seller')}}
                                                            :</label>
                                            ...
                                            <div class="">
                                                ...
                                                @if($condition)
                                                    @if($order->final_order_status == 2)
                                                        <div class="col-12 m-0 p-0">
                                                            <button type="submit"
                                                                    class="btn btn-block btn-success fs-16" disabled><i
                                                                    class="las la-check-circle"></i> {{ translate(' Accepted')  }}
                                                            </button>
                                                        </div>
                                                    ...
                                                    @else
                                                        <div class="col-12 m-0 p-0">
                                                            <button type="submit"
                                                                    class="btn btn-block btn-soft-primary " {{$order->preorder_product?->is_prepayment && $order->prepayment_confirm_status == 2 ? '' : ( $order->request_preorder_status == 2 ? '' : 'disabled')}}>{{  translate('Request')  }}</button>
                                                        </div>
                                                    @endif
                                                @endif
                                            </div>
                            ...
                            @if($order->shipping_status ==2)
                                ...
                                <div class="card rounded-0 border shadow-none"
                                    ...
                                    <div id="collapseShippingInfo" class="collapse "
                                        ...
                                        <div class="card-body" id="shipping_info">
                                            <div class="row preorder-border-dashed-grey p-4 m-4 rounded-2">
                                                <div class="col d-flex justify-content-between">
                                                    ...
                                                    <div class="ml-4">
                                                        <p><img class="w-50px h-50px"
                                                                src="{{ get_file_by_id($order->shipping_proof) }}"
                                                                alt=""></p>
                            ...
                            @if($order->delivery_status ==2)
                                ...
                                <div class="card rounded-0 border shadow-none"
                                     style="margin-bottom: 2rem; border-radius: 0.5rem !important;">
                                    <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingDeliverInfo"
                                         type="button" data-toggle="collapse" data-target="#collapseDeliverInfo"
                                         aria-expanded="true" aria-controls="collapseDeliverInfo">
                                        <div class="d-flex align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                 viewBox="0 0 20 20">
                                                <path id="Path_42357" data-name="Path 42357"
                                    ...
                                    <div id="collapseDeliverInfo" class="collapse " aria-labelledby="headingDeliverInfo"
                                         data-parent="#accordioncCheckoutInfo">
                                        <div class="card-body" id="delivery_info">
                                            <div class="">
                                                <div class="row preorder-border-dashed-grey p-4 m-4 rounded-2">
                            ...
                            @if($order->preorder_product?->is_refundable && $order->delivery_status==2)
                                ...
                                <div class="card rounded-0 border shadow-none"
                                     style="margin-bottom: 2rem; border-radius: 0.5rem !important;">
                                    <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingRefundRequest"
                                         type="button" data-toggle="collapse" data-target="#collapseRefundRequest"
                                         aria-expanded="true" aria-controls="collapseRefundRequest">
                                        <div class="d-flex align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                 viewBox="0 0 20 20">
                                                <path id="Path_42357" data-name="Path 42357"
                                                      d="M58,48A10,10,0,1,0,68,58,10,10,0,0,0,58,48ZM56.457,61.543a.663.663,0,0,1-.423.212.693.693,0,0,1-.428-.216l-2.692-2.692.856-.856,2.269,2.269,6-6.043.841.87Z"
                                                      transform="translate(-48 -48)"
                                                      fill="{{ preorder_fill_color($order->refund_status) }}"/>
                                            </svg>
                                        ...
                                        <div>
                                            @if($order->refund_status == 2)
                                                <span
                                                    class="badge badge-inline badge-success m-2 p-2 rounded-3 mr-4">{{ translate('Accepted')}}</span>
                                            @elseif($order->refund_status == 3)
                                                <span
                                                    class="badge badge-inline badge-danger m-2 p-2 rounded-3 mr-4">{{ translate('Rejected')}}</span>
                                            @endif
                                            <i class="las la-angle-down fs-18"></i>
                                        </div>
                                    ...
                                    <div id="collapseRefundRequest" class="collapse "
                                         aria-labelledby="headingRefundRequest" data-parent="#accordioncCheckoutInfo">
                                        <div class="card-body" id="shipping_info">
                                            <form action="{{route('preorder.order_update', $order->id)}}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="preorder-border-dashed-grey mt-0">
                                                    <div class="row px-4  d-flex ">
                                                        <div class="col-12">
                                                            <div class="form-group ">
                                                                <label class="col-form-label"
                                                                       for="signinSrEmail">{{translate('Refund Image')}}</label>
                                                                <div class="input-group" data-toggle="aizuploader"
                                                                     data-type="image">
                                                        ...
                                                        <div class="col-12">
                                                            @if($order->refund_status == 0)
                                                                <div class="form-group ">
                                                                    <label class="col-form-label"
                                                                           for="signinSrEmail">{{translate('Note')}}
                                                                        <span
                                                            ...
                                                            @if($order->refund_note != null)
                                                                <div>
                                                                    <div class="mt-4">
                                                                        <p class="border p-2"
                                                                           style="font-style: italic;"> {{ $order->refund_note }}</p>
                                                                    </div>
                                                                </div>
                                                            @endif
                            ...
                            @if($order->delivery_status ==2)
                                ...
                                <div class="card rounded-0 border shadow-none"
                                     style="margin-bottom: 2rem; border-radius: 0.5rem !important;">
                                    <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingReviewRating"
                                         type="button" data-toggle="collapse" data-target="#collapseReviewRating"
                                         aria-expanded="true" aria-controls="collapseReviewRating">
                                        <div class="d-flex align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                 viewBox="0 0 20 20">
                                                <path id="Path_42357" data-name="Path 42357"
                                                      d="M58,48A10,10,0,1,0,68,58,10,10,0,0,0,58,48ZM56.457,61.543a.663.663,0,0,1-.423.212.693.693,0,0,1-.428-.216l-2.692-2.692.856-.856,2.269,2.269,6-6.043.841.87Z"
                                                      transform="translate(-48 -48)"
                                                      fill="{{is_review_given($order)}}"/>
                                            </svg>
                                            <span class="ml-2 fs-19 fw-700">{{ translate('Your Review') }}</span>
                                        </div>
                                        <i class="las la-angle-down fs-18"></i>
                                    </div>
                                    <div id="collapseReviewRating" class="collapse "
                                         aria-labelledby="headingReviewRating" data-parent="#accordioncCheckoutInfo">
                                        <div class="card-body" id="shipping_info">
                                            <div class="bg-white border mb-4 rounded-2">
                                                <div class="p-3 p-sm-4">
                                                    <h3 class="fs-16 fw-700 mb-0">
                                                        <span
                                                            class="mr-4 text-uppercase">{{ translate('Your Reviews & Ratings') }}</span>
                                                    </h3>
                                                </div>
                                                <!-- Ratting -->
                                                    ...
                                                    <div class="border border-secondary-base  p-3 p-sm-4 rounded-2">
                                                        <div class="row align-items-center">
                                                            <div class="col-md-6 mb-3">
                                                                <div
                                                                    class=" align-items-center  justify-content-md-start">

                                                                    <div class="w-100 ">
                                                                        <span
                                                                            class="fs-48 fw-700 mr-3 d-block mb-0">{{ $order->preorder_product?->rating }}</span>

                                                                        <span
                                                                            class="fs-14 mr-3 d-block mt-0">{{ translate('out of 5.0') }}</span>
                                                                    </div>

                                                                    <div
                                                                        class="mt-sm-1 w-100 w-sm-auto d-flex flex-wrap justify-content-end justify-content-md-start">
                                                                        @php
                                                                            $total = 0;
                                                            ...
                                                            <div class="col-md-6 text-left">
                                                                ...
                                                                <div>
                                                                    <span
                                                                        class="d-block fs-14 fw-700">{{translate('Review this product')}}</span>
                                                                    <span
                                                                        class="d-block fs-14">{{translate('Share your experience with others')}}</span>
                                                                </div>

                                                                <a href="javascript:void(0);"
                                                                   onclick="preorder_product_review('{{ $order->preorder_product?->id }}')"
                                                                   class="btn px-4 border-yellow hov-bg-yellow p1-3 rounded-4 mt-3">
                                                                    <span
                                                                        class="d-md-inline-block "> {{ translate('Rate this Product') }}</span>
                                                                </a>
