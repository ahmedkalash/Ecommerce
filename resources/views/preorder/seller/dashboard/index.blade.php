        ...
        <div class="col-lg-12">
            <div class="row gutters-16">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="dashboard-box bg-white h-200px mb-2rem overflow-hidden"
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="dashboard-box h-200px mb-2rem overflow-hidden preorder-dashboard-box"
                                    ...
                                    <div class="border-bottom-dashed">
                                        <p class="fs-14 fw-600 text-dark mb-1">
                                            <a href="{{ route('seller.delayed_prepayment_preorders.list') }}"
                                               class="text-dark">{{translate('Delayed prepayment orders')}} <i
                                    ...
                                    <div class=" mt-3">
                                        <p class="fs-14 fw-600 text-dark mb-1">
                                            <a href="{{ route('seller.delayed_final_orders.list') }}"
                                               class="text-dark">{{translate('Delayed Final Orders')}} <i
                                                    class="las la-arrow-right"></i></a>
                                        </p>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="my-4 pt-4">
                                        <a href="{{ route('seller.all_preorder.list') }}">
                                            <button
                                                class="btn btn-block text-white bg-gunmetal-blue">{{translate('View all Preorders')}}</button>
                                        </a>
                                    </div>
            ...
            <div class="border mt-4 p-4">
                <div class="dashboard-box bg-white mb-2rem overflow-hidden p-2rem">
                    ...
                    <div class="position-relative">
                        <div
                            class="top_sellers_product_table top-products-table table-responsive c-scrollbar-light show"
                            style="width: 100%;">
                                        ...
                                        <td class="pl-0" style="vertical-align: middle">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="{{ $product_url }}" target="_blank"
                                                   class="d-block fw-400 ml-2 fs-13"
                                                   title="{{ $product->getTranslation('product_name') }}">
