            ...
            <div class="col-md-8 col-sm-12">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="preorder-border-dashed p-4 rounded-2 d-flex justify-content-between row">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mb-1 p-0">
                                        <span>{{ translate('Prepay') }}</span> {{format_price($order->prepayment)}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                ...
                <div class="accordion mt-4" id="accordioncCheckoutInfo">
                                        ...
                                        @if(in_array($requestPreorderStatus, [2, 3]))
                                            <div class="col-md-12 col-sm-12 mt-1">
                                                <button type="button"
                                                        ...
                                                        disabled>
                                                    @if($requestPreorderStatus == 2)
                                                        <i class="las la-check-circle"></i>
                                                    @endif {{  $requestPreorderStatus == 2 ? translate(' Accepted') : translate('Rejected')  }}
                                                </button>
                                            </div>
                    ...
                    @if($order->preorder_product->is_prepayment)
                        <!-- Prepayment Request -->
                        <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                            <div class="card-header border-bottom-0 py-3 py-xl-4" id="headingPrepaymentRequest"
                                 type="button"
                            ...
                            <div id="collapsePrepaymentRequest" class="collapse "
                                 aria-labelledby="headingPrepaymentRequest"
                                 data-parent="#accordioncCheckoutInfo">
                                <div class="card-body" id="shipping_info">
                                        ...
                                        <form action="{{route('seller.preorder-order.status_update', $order->id)}}"
                                            ...
                                            <div class="row preorder-border-dashed p-4 m-4">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    @if($order->prepayment_note)
                                                        <p class="border p-2"
                                                           style="font-style: italic;"> {{ $order->prepayment_note }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="row px-4">
                                                ...
                                                @if($order->prepayment_confirm_status == 2 )
                                                    <div class="col-md-12 col-sm-12 mt-1">
                                                        <button type="button" class="btn btn-block btn-success fs-16"
                                                                disabled><i
                    ...
                    <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                        ...
                        <div id="collapseFinalPreorder" class="collapse " aria-labelledby="headingFinalPreorder"
                            ...
                            <div class="card-body" id="shipping_info">
                                ...
                                <form action="{{route('seller.preorder-order.status_update', $order->id)}}"
                                      method="POST" id="final_order_form">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="row preorder-border-dashed p-4 m-4">
                                            ...
                                            <div class="col-12">
                                                ...
                                                @if($order->final_oder_note)
                                                    <p class="border p-2"
                                                       style="font-style: italic;"> {{ $order->final_oder_note }}</p>
                                                @endif
                                            </div>
                                        </div>
                    ...
                    <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                        ...
                        <div id="collapseInShipping" class="collapse " aria-labelledby="headingInShipping"
                            ...
                            <div class="card-body" id="shipping_info">
                                <form action="{{route('seller.preorder-order.status_update', $order->id)}}"
                                      method="POST" id="shipping_status_form">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row p-4  preorder-border-dashed p-4 m-4 d-flex ">
                                        ...
                                        <div class="col-12">
                                            ...
                                            @if($order->shipping_note)
                                                <p class="border p-2"
                                                   style="font-style: italic;"> {{ $order->shipping_note }}</p>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row px-4">
                                        ...
                                        @if($order->shipping_status == 2 )
                                            <div class="col-md-12 col-sm-12 mt-1">
                                                <button type="button" class="btn btn-block btn-success fs-16" disabled>
                                                    <i class="las la-check-circle"></i> {{ translate(' Marked as shipping')  }}
                                                </button>
                                            </div>
                    ...
                    <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                        ...
                        <div id="collapseDelivery" class="collapse" aria-labelledby="headingDelivery"
                            ...
                            <div class="card-body" id="shipping_info">
                                <form action="{{route('seller.preorder-order.status_update', $order->id)}}"
                                      method="POST" id="delivery_status_form">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="">
                                        ...
                                        <div class="col-12 px-4">
                                            ...
                                            @if($order->delivery_note)
                                                <p class="border p-2"
                                                   style="font-style: italic;"> {{ $order->delivery_note }}</p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="row px-4">
                                            ...
                                            @if($order->delivery_status == 2)
                                                <div class="col-md-12 col-sm-12 mt-1">
                                                    <button type="button" class="btn btn-block btn-success fs-16"
                                                            disabled><i
                                                            class="las la-check-circle"></i> {{ translate(' Delivered')  }}
                                                    </button>
                                                </div>
                    ...
                    @if($order->preorder_product->is_refundable && $order->delivery_status==2)
                        ...
                        <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                                    ...
                                    <div class="rounded-circle d-flex justify-content-center align-items-center"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="2" height="10"
                                            ...
                                            <g id="Group_38901" data-name="Group 38901"
                                               transform="translate(-315 -540)">
                                                <rect id="Rectangle_23991" data-name="Rectangle 23991" width="2"
                                                      height="7" rx="1" transform="translate(315 540)" fill="#fff"/>
                                                <rect id="Rectangle_23992" data-name="Rectangle 23992" width="2"
                                                      height="2" rx="1" transform="translate(315 548)" fill="#fff"/>
                                            </g>
                                        </svg>
                                    </div>
                            ...
                            <div id="collapseRefund" class="collapse " aria-labelledby="headingRefund"
                                ...
                                <div class="card-body" id="shipping_info">
                                    <form action="{{route('seller.preorder-order.status_update', $order->id)}}"
                                          method="POST" id="refund_status_form">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="">
                                            <div class="row preorder-border-dashed p-4 m-4">
                                                <div class="col d-flex justify-content-between">
                                                    ...
                                                    <div class="ml-4">
                                                        <p><img class="w-50px h-50px"
                                                                src="{{ get_file_by_id($order->refund_proof) }}" alt="">
                                                        </p>
                                            ...
                                            <div class="col-12 px-4">
                                                ...
                                                @if($order->seller_refund_note)
                                                    <p class="border p-2"
                                                       style="font-style: italic;"> {{ $order->seller_refund_note }}</p>
                                                @endif
                                            </div>
                                            <div class="row px-4">
                                                {{-- button --}}
                ...
                <div class="modal-body">
                    ...
                    <span class="avatar avatar-xxl mb-3">
                        @if ($order->user->avatar != null)
                            <img src="{{ get_file_by_id($order->user->avatar_original) }}">
                        @else
                            <img src="{{ get_file_by_path('assets/frontend/default/img/avatar-place.png') }}0"
