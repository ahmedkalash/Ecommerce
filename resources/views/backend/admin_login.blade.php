                        ...
                        <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center border right-content"
                            ...
                            <div class="text-center text-lg-left">
                                <h1 class="fs-20 fs-md-24 fw-700 text-primary"
                                    style="text-transform: uppercase;">{{ translate('Admin Panel') }}</h1>
                                <h5 class="fs-14 fw-400 text-dark">{{ translate('Login to your admin account')}}</h5>
                            </div>

                            <!-- Login form -->
                            <div class="pt-3">
                                <div class="">
                                    <form class="form-default" id="admin-login-form" role="form"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email"
                                                   ...
                                                   value="{{ old('email') }}"
                                                   placeholder="{{  translate('admin@example.com') }}" name="email"
                                        ...
                                        <div class="mb-4 mt-4">
                                            <button type="submit"
                                                    class="btn btn-primary btn-block fw-700 fs-14 rounded-0">{{ translate('Login to Admin Panel') }}</button>
                                        </div>
                                    </form>
