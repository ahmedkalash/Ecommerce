            ...
            <div class="row">
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                    <label class="aiz-megabox mb-3">
                        <input value="bottom-left" class="custom_alert_location" type="radio"
                               onchange="confirm_alert_location('bottom-left')"
                               @if(get_setting('custom_alert_location')=='bottom-left' ) checked @endif>
                        <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ static_asset('assets/img/alerts/alert-bottom-left.png') }}" class="h-100 w-100"
                                 alt="alert">
                        </div>
                    </span>
                    </label>
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                    <label class="aiz-megabox mb-3">
                        <input value="bottom-right" class="custom_alert_location" type="radio"
                               onchange="confirm_alert_location('bottom-right')"
                               @if(get_setting('custom_alert_location')=='bottom-right' ) checked @endif>
                        <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ static_asset('assets/img/alerts/alert-bottom-right.png') }}"
                                 class="h-100 w-100" alt="alert">
                        </div>
                    </span>
                    </label>
                    <br>
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                    <label class="aiz-megabox mb-3">
                        <input value="top-left" class="custom_alert_location" type="radio"
                               onchange="confirm_alert_location('top-left')"
                               @if(get_setting('custom_alert_location')=='top-left' ) checked @endif>
                        <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ static_asset('assets/img/alerts/alert-top-left.png') }}" class="h-100 w-100"
                                 alt="alert">
                        </div>
                    </span>
                    </label>
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-6 my-3">
                    <label class="aiz-megabox mb-3">
                        <input value="top-right" class="custom_alert_location" type="radio"
                               onchange="confirm_alert_location('top-right')"
                               @if(get_setting('custom_alert_location')=='top-right' ) checked @endif>
                        <span class="d-block aiz-megabox-elem rounded-0">
                        <div class="h-120px w-180px overflow-hidden">
                            <img src="{{ static_asset('assets/img/alerts/alert-top-right.png') }}" class="h-100 w-100"
                                 alt="alert">
                        </div>
                    </span>
                    </label>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="size-64px rounded-2 overflow-hidden">
                                    <img class="h-100 img-fit" src="{{ get_file_by_id($custom_alert->banner) }}" alt="">
                                </div>
                            </td>
                            ...
                            <td>
                                @if($custom_alert->id != 1)
                                    @if($custom_alert->type == 'small')
                                        <span
                                            class="bg-primary text-white px-3 py-2 rounded-2">{{ translate('Small') }}</span>
                                    @else
                                        <span
                                            class="bg-danger text-white px-3 py-2 rounded-2">{{ translate('Large') }}</span>
                                    @endif
                                @else
                                    <span
                                        class="bg-secondary text-white px-3 py-2 rounded-2">{{ translate('default') }}</span>
                                @endif
                            </td>
                            <td>
                                <label class="aiz-switch aiz-switch-primary mb-0">
                                    ...
                                    value="{{ $custom_alert->id }}" id="trigger_alert_{{ $custom_alert->id }}"
                                        type="checkbox" @if($custom_alert->status == 1) checked @endif
                            ...
                            <td>
                                <div class="dropdown float-right">
                                    <button class="btn btn-light size-40px action-toggle dropdown-toggle" type="button"
                                            data-toggle="dropdown" aria-haspopup="false" aria-expanded="false">
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                        @can('edit_custom_alerts')
                                            <a class="dropdown-item"
                                               href="{{route('custom-alerts.edit', $custom_alert->id)}}">
                                                {{translate('Edit')}}
                                            </a>
                                        @endcan
                                        @if($custom_alert->id != 1)
                                            @can('delete_custom_alerts')
                                                <a class="dropdown-item confirm-delete" href="javascript:void(0)"
                                                   data-href="{{route('custom-alerts.destroy', $custom_alert->id)}}">
                                                    {{translate('Delete')}}
                                                </a>
                                            @endcan
                                        @endif
            ...
            <div class="modal-content p-2rem">
                <div class="modal-body text-center">
                    ...
                    <a href="javascript:void(0)" id="trigger_btn" data-value="" data-status="" data-clicked=""
                       ...
                       onclick="update_custom_alert_status()"></a>
                </div>
            </div>
        </div>
    </div><!-- /.modal -->
