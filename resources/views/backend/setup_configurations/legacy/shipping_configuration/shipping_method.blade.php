        ...
        <div class="col-md-8">
            ...
            <form action="{{ (Route::has('shipping_configuration.update') ? route('shipping_configuration.update') : '#') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mx-1 shipping-card">
                    ...
                    <div class="col-md-6 col-lg-4 d-flex">
                        <div class="card text-center px-3 py-4 w-100" data-shipping="Area Wise Shipping Cost">
                            <img src="{{ static_asset('assets/img/shipping/area_wise_flat_shipping.png') }}"
                                 class="card-img-top mx-auto" alt="Shipping Icon">

                            <div class="text-left mx-4">
                                <div class="d-flex align-items-left justify-content-left mb-2">
                                    <input type="radio" hidden id="areaWiseFlatShipping" class="mr-2"
                                           name="shipping_type" value="area_wise_shipping"
                                           @if(get_setting('shipping_type')=='area_wise_shipping' ) checked @endif>
                    ...
                    <div class="col-md-6 col-lg-4 d-flex">
                        <div class="card text-center px-3 py-4 w-100" data-shipping="Product Wise Shipping Cost">
                            <img src="{{ static_asset('assets/img/shipping/product_wise_shipping.png') }}"
                                 class="card-img-top mx-auto" alt="Shipping Icon">

                            <div class="text-left mx-4">
                                <div class="d-flex align-items-left justify-content-left mb-2">
                                    <input type="radio" hidden id="productWiseShipping" class="mr-2"
                                           name="shipping_type" value="product_wise_shipping"
                                           @if(get_setting('shipping_type')=='product_wise_shipping' ) checked @endif>
                    ...
                    <div class="col-md-6 col-lg-4 d-flex">
                        <div class="card text-center px-3 py-4 w-100" data-shipping="Flat Rate Shipping Cost">
                            <img src="{{ static_asset('assets/img/shipping/flat_rate_shipping.png') }}"
                                 class="card-img-top mx-auto" alt="Shipping Icon">

                            <div class="text-left mx-4">
                                <div class="d-flex align-items-left justify-content-left mb-2">
                                    <input type="radio" hidden id="flatRateShipping" class="mr-2" name="shipping_type"
                                           value="flat_rate"
                                           @if(get_setting('shipping_type')=='flat_rate' ) checked @endif>
                    ...
                    <div class="col-md-6 col-lg-4 d-flex">
                        <div class="card text-center px-3 py-4 w-100" data-shipping="Seller Wise Shipping Cost">
                            <img src="{{ static_asset('assets/img/shipping/seller_wise_flat_shipping.png') }}"
                                 class="card-img-top mx-auto" alt="Shipping Icon">

                            <div class="text-left mx-4">
                                <div class="d-flex align-items-left justify-content-left mb-2">
                                    <input type="radio" hidden id="sellerWiseFlatShipping" class="mr-2"
                                           name="shipping_type" value="seller_wise_shipping"
                                           @if(get_setting('shipping_type')=='seller_wise_shipping' ) checked @endif>
                    ...
                    <div class="col-md-6 col-lg-4 d-flex">
                        <div class="card text-center px-3 py-4 w-100" data-shipping="Carrier Wise Shipping Cost">
                            <img src="{{ static_asset('assets/img/shipping/carrier_wise_shipping.png') }}"
                                 class="card-img-top mx-auto" alt="Shipping Icon">

                            <div class="text-left mx-4">
                                <div class="d-flex align-items-left justify-content-left mb-2">
                                    <input type="radio" hidden name="shipping_type" value="carrier_wise_shipping"
                                           @if(get_setting('shipping_type')=='carrier_wise_shipping' ) checked
                                           @endif class="mr-2">
                ...
                <div class="row mx-1 mb-4">
                    <div class="col-xl-8 ">
                        <button class="btn bg-blue-color2 text-primary w-100 "><small class="font-weight-bold">You have
                                selected <span id="dynamic-text"> ... </span></small></button>
                    </div>
                    <div class="col-xl-4 mt-2 mt-xl-0">
                        <button class="btn btn-primary w-100"
                                type="submit">{{ translate('SET SHIPPING METHOD') }}</button>
                    </div>
                </div>
            </form>
        </div>
