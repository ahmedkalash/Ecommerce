                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="RECAPTCHA_SCORE_THRESHOLD"
                                    ...
                                    <option value="0.3" {{ env('RECAPTCHA_SCORE_THRESHOLD') == '0.3' ? 'selected' : '' }}>
                                        More than or equal to 0.3
                                    </option>
                                    <option value="0.5" {{ env('RECAPTCHA_SCORE_THRESHOLD') == '0.5' ? 'selected' : '' }}>
                                        More than or equal to 0.5
                                    </option>
                                    <option value="0.7" {{ env('RECAPTCHA_SCORE_THRESHOLD') == '0.7' ? 'selected' : '' }}>
                                        More than or equal to 0.7
                                    </option>
                                    <option value="0.9" {{ env('RECAPTCHA_SCORE_THRESHOLD') == '0.9' ? 'selected' : '' }}>
                ...
                <div class="card-body">
                    <ul class="list-group">
                        <li class="list-group-item">
                            1. Score: 0.0 - 0.3 : <strong>Very likely a bot</strong> — Recommended Action: Block the
                            request or require additional verification.
                        </li>
                        <li class="list-group-item">
                            2. Score: 0.3 - 0.5 : <strong>Suspicious activity</strong> — Recommended Action: Might want
                            to require additional verification.
                        </li>
                        <li class="list-group-item">
                            3. Score: 0.5 - 0.7 : <strong>Possibly human</strong> — Recommended Action: Could be
                            legitimate traffic.
                        </li>
                        <li class="list-group-item">
                        ...
                        <li class="list-group-item">
                            5. Score: 0.9 - 1.0 : <strong>Very likely human</strong> — Recommended Action: Definitely
                            safe to allow.
                        </li>
                        <li class="list-group-item">
                            6. If Google reCAPTCHA v3 credentials have not yet been created, please register your site
                            by visiting
            ...
            <div class="modal-content p-2rem">
                <div class="modal-body text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="72" height="64" viewBox="0 0 72 64">
                        <path d="M40.159,3.309a4.623,4.623,0,0,0-7.981,0L.759,58.153a4.54,4.54,0,0,0,0,4.578A4.718,4.718,0,0,0,4.75,65.02H67.587a4.476,4.476,0,0,0,3.945-2.289,4.773,4.773,0,0,0,.046-4.578Zm.6,52.555H31.582V46.708h9.173Zm0-13.734H31.582V23.818h9.173Z"
                              fill="#ffc700"/>
                    </svg>
