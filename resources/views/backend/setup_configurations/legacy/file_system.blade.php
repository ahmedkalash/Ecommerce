                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="BACKBLAZE_URL"
                                       value="{{  env('BACKBLAZE_URL') }}"
                                       placeholder="{{ translate('BACKBLAZE_URL') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-12 text-right">
        ...
        <div class="col-xxl-6">
                ...
                <div class="card-body">
                    <label class="aiz-switch mb-0">
                        <input type="radio" name="FILESYSTEM_DRIVER"
                               onchange="updateSettings(this, 'FILESYSTEM_DRIVER', 'aws')" <?php if (env('FILESYSTEM_DRIVER') == 'aws') echo "checked"; ?>>
                        <span></span>
                    </label>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <label class="aiz-switch mb-0">
                        <input type="radio" name="FILESYSTEM_DRIVER"
                               onchange="updateSettings(this, 'FILESYSTEM_DRIVER', 'backblaze')" <?php if (env('FILESYSTEM_DRIVER') == 'backblaze') echo "checked"; ?>>
                        <span></span>
                    </label>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <label class="aiz-switch mb-0">
                        <input type="radio" name="FILESYSTEM_DRIVER"
                               onchange="updateSettings(this, 'FILESYSTEM_DRIVER', 'local')" <?php if (env('FILESYSTEM_DRIVER') == 'local') echo "checked"; ?>>
                        <span></span>
                    </label>
                </div>
            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker mb-2 mb-md-0" name="CACHE_DRIVER">
                                    <option value="file"
                                            @if (env('CACHE_DRIVER') == "file") selected @endif>{{ translate('file') }}</option>
                                    <option value="redis"
                                            @if (env('CACHE_DRIVER') == "redis") selected @endif>{{ translate('redis') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker mb-2 mb-md-0" name="SESSION_DRIVER">
                                    <option value="file"
                                            @if (env('SESSION_DRIVER') == "file") selected @endif>{{ translate('file') }}</option>
                                    <option value="redis"
                                            @if (env('SESSION_DRIVER') == "redis") selected @endif>{{ translate('redis') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="REDIS_PASSWORD"
                                       ...
                                       placeholder="{{ translate('REDIS_PASSWORD') }}">
                            </div>
                        </div>
                        <div class="form-group row">
