                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ (Route::has('whatsapp_chat.update') ? route('whatsapp_chat.update') : '#') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="whatsapp_chat" type="checkbox"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <label class="aiz-switch aiz-switch-success mb-0 ">
                                    <input value="1" id="whatsapp_order_switch" name="whatsapp_order" type="checkbox"
                        ...
                        <div class="form-group row message-area">
                            ...
                            <div class="col-md-7">
                                <label class="aiz-switch aiz-switch-success mb-0 ">
                                    <input value="1" id="whatsapp_order_seller_prods" name="whatsapp_order_seller_prods"
                                           type="checkbox" @if (get_setting('whatsapp_order_seller_prods') == 1)
                                               checked
                                            @endif>
                                    <span class="slider round"></span>
                                </label>
                            ...
                            <div class="col-md-7">
                                <textarea class="form-control" rows="5" placeholder="{{translate('Order Message')}}"
                                          name="order_messege_template">{{get_setting('order_messege_template')}}</textarea>
                            </div>
