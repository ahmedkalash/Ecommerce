@foreach ($inhouse_top_brands as $inhouse_top_brand)
    <div class="d-flex  flex-lg-wrap flex-xxl-nowrap align-items-center justify-content-between"
         style="margin-bottom: 0.75rem;">
        <div class="d-flex align-items-center mr-2">
            <div class="d-flex align-items-center rounded-2 border overflow-hidden mr-3"
                 style="min-height: 48px !important; min-width: 48px !important;max-height: 48px !important; max-width: 48px !important;">
                <img src="{{ get_file_by_id($inhouse_top_brand->logo) }}" alt="{{ translate('brand') }}"
