                    ...
                    <table class="table aiz-table mb-0">
                        ...
                        @foreach($warranties as $key => $warranty)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ get_file_by_id($warranty->logo) }}"
                                         alt="{{translate('Warranty Logo')}}" class="h-50px">
                                </td>
                                <td class="text-right">
                                    @can('edit_product_warranty')
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                           href="{{route('warranties.edit', ['id'=>$warranty->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}"
                                    ...
                                    @can('delete_product_warranty')
                                        <a href="#"
                                           ...
                                           data-href="{{route('warranties.destroy', $warranty->id)}}"
                    ...
                    <div class="card-body">
                        <form action="{{ route('warranties.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="warranty_text" class="form-control"
                                       placeholder="{{translate('Warranty Text')}}" id="warranty_text" required>
                            </div>
                            <div class="form-group mb-3">
                                <label for="name">{{translate('Logo')}} <small>({{ translate('40x40') }}
                                        )</small></label>
                                ...
                                <small
                                    class="text-muted">{{ translate('Minimum dimensions required: 40px width X 40px height.') }}</small>
                            </div>
