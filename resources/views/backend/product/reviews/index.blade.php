        ...
        <div class="row align-items-center">
            ...
            @can('add_custom_review')
                <div class="col text-right">
                    <a href="{{ route('custom-review.create', null) }}" class="btn btn-sm rounded-2"
        ...
        <form class="" action="" id="sort_reiewed_products" method="GET">
            <div class="card-header row gutters-5">
                ...
                <div class="col-lg-2 ml-auto">
                    <select class="form-control form-control-sm aiz-selectpicker" name="seller_id" id="seller_id"
                            onchange="sort_reiewed_products()" data-selected="{{ $sellerID }}">
