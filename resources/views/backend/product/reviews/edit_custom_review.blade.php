    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('custom-review.update') }}" method="POST"
                          enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $review->id }}">
                        <div class="form-group">
                            <label for="custom_reviewer_name">{{ translate('Custom Reviewer Name')}} <span
                                    class="text-danger">*</span></label>
                            <input type="text" name="custom_reviewer_name" value="{{ $review->custom_reviewer_name }}"
                                   class="form-control" id="custom_reviewer_name" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" name="custom_reviewer_image"
                                           value="{{ $review->custom_reviewer_image }}" class="selected-files"
                                           id="custom_reviewer_image">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
                            <small
                                class="text-muted">{{translate("If you do not use custom reviewer's image it will show default user image.")}}</small>
                        </div>

                        <div class="form-group">
                            <label for="product">{{ translate('Category')}}</label>
                            <input type="text" value="{{ $review->product->main_category->getTranslation('name') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="rating rating-input">
                                <label>
                                    <input type="radio" name="rating" value="1" @if($review->rating == 1) checked
                                           @endif required>
                        ...
                        <div class="form-group">
                                ...
                                @if($review->created_at_is_custom == 0)
                                    <div class="d-flex mb-4">
                                        <div class="radio mar-btm mr-5 d-flex align-items-center">
                                            ...
                                            <label for="system_date"
                                                   class="mb-0 ml-2">{{translate('System Date')}}</label>
                                        </div>
                            ...
                            <div class="date-selection-div @if($review->created_at_is_custom == 0) d-none @endif">
                                <input type="text" class="form-control aiz-date-range" name="custom_date"
                                       value="{{ $review->created_at }}" placeholder="{{ translate('Select Date') }}"
                                       data-single="true" data-time-picker="true" data-format="Y-MM-DD HH:mm:ss"
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <div class="input-group" data-toggle="aizuploader" data-type="image"
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="photos[]" value="{{ $review->photos }}"
