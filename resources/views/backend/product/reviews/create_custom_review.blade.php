                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('reviews.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="custom_reviewer_name" class="form-control"
                                   id="custom_reviewer_name" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" name="custom_reviewer_image" class="selected-files"
                        ...
                        <div class="form-group">
                            ...
                            @if($product != null)
                                <input type="text" value="{{ $product->main_category->getTranslation('name') }}"
                            ...
                            @else
                                <select class="form-control aiz-selectpicker"
                                    ...
                                    @foreach ($categories as $p_category)
                                        <option
                                            value="{{ $p_category->id }}">{{ $p_category->getTranslation('name') }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-100">
                                <div class="d-flex mb-4">
                                    <div class="radio mar-btm mr-5 d-flex align-items-center">
                                        <input id="system_date" type="radio" name="review_date_type" value="system_date"
                                               onchange="reviewDateType()" checked>
                                        <label for="system_date" class="mb-0 ml-2">{{translate('System Date')}}</label>
                                    </div>
                                    <div class="radio mar-btm mr-3 d-flex align-items-center">
                                        <input id="custom_date" type="radio" name="review_date_type" value="custom"
                            ...
                            <div class="date-selection-div d-none">
                                <input type="text" class="form-control aiz-date-range" name="custom_date"
                                       ...
                                       data-time-picker="true" data-format="Y-MM-DD HH:mm:ss" data-show-dropdown="true"
                                       autocomplete="off">
                            </div>
                        </div>
