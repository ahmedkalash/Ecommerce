        ...
        <div class="row align-items-center">
            ...
            @can('add_custom_review')
                <div class="col text-right">
                    <a href="{{ route('custom-review.create', $product->id) }}" class="btn btn-sm rounded-2"
                       style="background-color: #299395; color: white;">
    ...
    <div class="card">
        <div class="d-flex justify-content-between">
            <div class="row gutters-5 w-400px w-md-500px align-items-center ml-1">
                <div class="col-auto">
                    <img src="{{ get_file_by_id($product->thumbnail_img)}}" alt="Image" class="size-80px img-fit">
                </div>
                <div class="col">
        ...
        <div class="card-body">
            <table class="table aiz-table mb-0">
                ...
                <tr class="opacity-70">
                    ...
                    <th @if($reviewType == 'real') class="text-right"
                        @endif width="20%">{{ strtoupper(translate('Published')) }}</th>
                ...
                @foreach($reviews as $key => $review)
                    <tr>
                            ...
                            @php
                                ...
                                if($review->type == "real"){
                                    if($review->user != null){
                                        ...
                                        $customerAvatar = get_file_by_id($review->user->avatar_original);
                                    }
                                    else {
                        ...
                        <td class="text-right">
                            <div
                                class="d-flex d-sm-flex @if($reviewType == 'real') justify-content-end @endif align-items-center">
                                ...
                                <div>
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input onchange="update_published(this)" value="{{ $review->id }}"
                                               type="checkbox" <?php if ($review->status == 1) echo "checked"; ?> >
                            ...
                            <td class="text-right">
                                @can('edit_custom_review')
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                       href="{{route('custom-review.edit', $review->id)}}"
