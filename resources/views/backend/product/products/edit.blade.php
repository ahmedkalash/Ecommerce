                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group" data-toggle="aizuploader" data-type="image"
                                                ...
                                                <input type="hidden" name="short_video_thumbnail"
                                                       value="{{ $product->short_video_thumbnail }}"
                                                       class="selected-files">
                                            </div>
                                            <div class="file-preview box sm">
                                            </div>
                                    ...
                                    <div class="form-group row gutters-5">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control aiz-selectpicker" data-live-search="true"
                                                    ...
                                                    multiple>
                                                @foreach (config('attributes.presets.color.options', []) as $color_name => $color_code)
                                                    <option
                                                            value="{{ $color_code }}"
                                                            data-content="<span><span class='size-15px d-inline-block mr-2 rounded border' style='background:{{ $color_code }}'></span><span>{{ $color_name }}</span></span>"
                                                            <?php if (in_array(
                                                                $color_code,
                                                                json_decode($product->colors) ?? []
                                                            )) {
                                                                echo 'selected';
                                                            } ?>></option>
                                                @endforeach
                                        ...
                                        <div class="col-md-1">
                                            <label class="aiz-switch aiz-switch-success mb-0">
                                                <input value="1" type="checkbox"
                                                       name="colors_active" <?php if (count(json_decode($product->colors)) > 0) {
                                                           echo 'checked';
                                                       } ?>>
                                                <span></span>
                                            </label>
                                            ...
                                            <select name="choice_attributes[]" id="choice_attributes"
                                                ...
                                                @foreach (config('attributes.presets') as $key => $attribute)
                                                    @if(isset($attribute['label']))
                                                        <option value="{{ $key }}"
                                                                @if($product->attributes != null && in_array($key, json_decode($product->attributes, true))) selected @endif>{{ translate($attribute['label']) }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control" name="choice[]"
                                                           value="{{ translate(config("attributes.presets.{$choice_option->attribute_id}.label", $choice_option->attribute_id)) }}"
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control aiz-selectpicker attribute_choice"
                                                        ...
                                                        @foreach (config("attributes.presets.{$choice_option->attribute_id}.options", []) as $option_key => $option_val)
                                                            @php $opt_val = is_numeric($option_key) ? $option_val : $option_key; @endphp
                                                            <option value="{{ $opt_val }}"
                                                                    @if(in_array($opt_val, $choice_option->values)) selected @endif>
                                                                {{ $opt_val }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                                    ...
                                                                    <tr class="remove-parent">
                                                                        ...
                                                                        <td class="w-150px pl-0"
                                                                            ...
                                                                            <p class="d-block size-48px">
                                                                                <img
                                                                                        src="{{ $fQBproduct->frequently_bought_product->thumbnail_img }}"
                                                                                        alt="{{ translate('Image')}}"
