                                    ...
                                    <div class="symbol-group">
                                        @foreach ($top_customers as $top_customer)
                                            <div class="symbol size-40px rounded-content overflow-hidden"
                                                ...
                                                <img src="{{ get_file_by_id($top_customer->avatar_original) }}"
                                ...
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between mb-2">
                                        <h3 class="fs-13 fw-600 mb-0 text-truncate mr-2">
                                            <span
                                                class="badge badge-md badge-dot badge-circle badge-success mr-2"></span>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <h3 class="fs-13 fw-600 text-truncate mr-2">
                                            <span
                                                class="badge badge-md badge-dot badge-circle badge-primary mr-2"></span>
                            ...
                            @if (get_setting('vendor_system_activation') == 1)
                                <div class="d-flex flex-column justify-content-between h-100">
                                    ...
                                    <div>
                                        <h3 class="fs-13 fw-600 mb-1">
                                            <span
                                                class="badge badge-md badge-dot badge-circle badge-warning mr-2"></span>
                                        ...
                                        <div class="symbol-group">
                                            @foreach ($top_sellers as $top_seller)
                                                <div class="symbol size-40px rounded-content overflow-hidden"
                                                    ...
                                                    <img src="{{ get_file_by_id($top_seller->avatar_original) }}"
                ...
                <div class="row gutters-16">
                    ...
                    <div class="col-sm-6">
                        <div class="dashboard-box px-0 mb-2rem overflow-hidden" style="height: 474px;">
                            ...
                            <!-- nav -->
                            <ul class="nav nav-tabs dashboard-tab dashboard-tab-primary border-0 px-2rem mb-3"
                                role="tablist"
                    ...
                    <div class="col-sm-6">
                        <div class="dashboard-box px-0 mb-2rem overflow-hidden" style="height: 474px;">
                            ...
                            <!-- nav -->
                            <ul class="nav nav-tabs dashboard-tab dashboard-tab-danger border-0 px-2rem mb-3"
                                role="tablist"
                                aria-orientation="vertical">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link inhouse_top_brands" id="today-tab" href="#today"
                                       data-toggle="tab"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link inhouse_top_brands" id="month-tab" href="#month"
                                       data-toggle="tab"
