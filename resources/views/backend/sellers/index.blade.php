                ...
                @if($route == 'all_seller_route')
                    ...
                    <div class="col-lg-2 ml-auto">
                        <select class="form-control aiz-selectpicker" name="verification_status"
                                onchange="sort_sellers()" data-selected="{{ $verification_status }}">
                    ...
                    <div class="col-md-2 ml-auto">
                        <select class="form-control aiz-selectpicker" name="approved_status" id="approved_status"
                            ...
                            <option value="1"
                                    @isset($approved) @if($approved == '1') selected @endif @endisset>{{translate('Approved')}}</option>
                            <option value="0"
                                    @isset($approved) @if($approved == '0') selected @endif @endisset>{{translate('Non-Approved')}}</option>
                        </select>
                    </div>
                @endif
                <div class="col-md-3">
                    <div class="form-group mb-0">
                        <input type="text" class="form-control" id="search" name="search"
                               ...
                               @endisset placeholder="{{ translate('Type name or email or mobile number & Enter') }}">
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row gutters-5  mw-100 align-items-center">
                                    <div class="col-auto">
                                        <img src="{{ get_file_by_id($shop->logo) }}" class="size-40px img-fit"
                                             alt="Image"
                                    ...
                                    <span class="text-truncate-2">
                                        ...
                                        @endif
                                    <a class="text-primary" href="{{route('sellers.profile', encrypt($shop->id))}}"
                                       target="_blank">{{ $shop->name }}</a></span>
                                    </div>
                                </div>
                            </td>
                            <td>{{$shop->user->phone}}
                                ...
                                <td>
                                    <div class="d-flex flex-column align-items-start">
                                        @if ($shop->verification_status != 1 && $shop->verification_info != null)
                                            <span
                                                class="badge badge-inline badge-warning mb-1"> {{ translate('Applied') }}</span>
                                        ...
                                        @elseif($shop->verification_status == 1 && $shop->verification_info != null)
                                            <span
                                                class="badge badge-inline badge-success mb-1"> {{ translate('Verified') }}</span>
                                            <a href="javascript:void();"
                                               onclick="show_seller_verification_info('{{$shop->id}}');"
                                               class="badge badge-inline badge-info">
                                                {{ translate('View Details') }}
                                        ...
                                        @else
                                            <span
                                                class="badge badge-inline badge-secondary"> {{ translate('Not Applied') }}</span>
                                        @endif
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                            ...
                                            @can('pay_to_seller')
                                                <a href="javascript:void();"
                                                   onclick="show_seller_payment_modal('{{$shop->id}}');"
                                                   class="dropdown-item">
                                            ...
                                            @can('delete_seller')
                                                <a href="javascript:void();" class="dropdown-item confirm-delete"
                                ...
                                <td>
                                    @if(auth()->user()->can('edit_seller_custom_followers'))
                                        <a href="javascript:void();"
                                           ...
                                           class="btn btn-primary btn-xs fs-10 fw-700">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" lang="en" min="0" step="1"
                                       placeholder="{{translate('Custom Followers')}}" value="" name="custom_followers"
                                       id="custom_followers" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
