            ...
            <div class="position-relative text-center supplier-banner mx-auto"
                ...
                <div
                    ...
                    <div class="mb-2" style="width: 80px; height: 80px;">
                        <img src="{{ get_file_by_id($shop->logo) }}"
                             alt="{{ $shop->name }}"
                        ...
                        @if($shop->verification_status)
                            <div class="icon-container ml-2" data-tooltip="Verified">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <g id="_6819ed6f635ef55dbc567842d82cbaf7"
                                       data-name="6819ed6f635ef55dbc567842d82cbaf7" transform="translate(-1 -1)">
                                        <path id="Path_42581" data-name="Path 42581"
                                              d="M9,1a8,8,0,1,0,8,8A8,8,0,0,0,9,1Z" fill="#00c96c"/>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap border-bottom">
                    ...
                    <div class="supplier-tab-wrapper">
                        <ul class="nav nav-tabs supplier-tab" id="customTabs">
                            ...
                            <li class="nav-item">
                                <button class="nav-link"
                                        onclick="changeSellerTab(this, 'payments')">{{translate('Payment History')}}</button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link"
                                        onclick="changeSellerTab(this, 'documents')">{{translate('Documents')}}</button>
                            </li>
                        </ul>
                    </div>
                        ...
                        @can('product_delete' || 'order_delete')
                            <div class="dropdown mb-2 mb-md-0 mr-3 bulk-action-visibility d-none">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                    <a class="dropdown-item fs-13 confirm-alert" href="javascript:void(0)"
                            ...
                            <button onclick="changeSellerTab(this, 'orders' , 'order_tab')"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="12.699" height="16"
                                    ...
                                    <g id="_901df7a6091730d2a30cc44cf8aa9e09"
                                       data-name="901df7a6091730d2a30cc44cf8aa9e09"
