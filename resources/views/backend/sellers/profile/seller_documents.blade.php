                            ...
                            <div class="dropdown-file">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="javascript:void(0)" class="dropdown-item"
                                       onclick="showFileInModal('{{ get_file_by_path($file_path) }}')">
                                        <span>{{translate('View')}}</span>
                                    </a>
                                    <a href="javascript:void(0)" class="dropdown-item"
                                       onclick="printFile('{{ get_file_by_path($file_path) }}')">
                                        <span>{{translate('Print')}}</span>
                                    </a>
                                    <a href="javascript:void(0)" class="dropdown-item confirm-delete"
                                       data-href="{{ route('seller.verification.file.delete', ['index' => $key, 'shop_id' => $shop->id, 'file_path' => $file_path]) }}">
                            ...
                            <div class="card card-file aiz-uploader-select c-default" title="{{ $file_name }}">
                                @if ($is_image)
                                    <div class="card-file-thumb">
                                        <img src="{{ get_file_by_path($file_path) }}" class="img-fit">
                                    </div>
