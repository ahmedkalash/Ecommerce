                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row gutters-5  mw-100 align-items-center">
                                <div class="col-auto">
                                    <img src="{{ get_file_by_id($shop->logo) }}" class="size-40px img-fit" alt="Image"
                        ...
                        <td>
                            <div class="input-group">
                                <input type="number" class="form-control" id="commission_{{ $shop->id }}" step="0.01"
                                       value="{{$shop->commission_percentage}}" min="0"
                        ...
                        <td class="text-right">
                            <div class="form-group mb-0 text-right">
                                <button type="button" onclick="trigger_alert({{ $shop->id }})"
                ...
                <div class="modal-body text-center">
                    ...
                    <div>
                        ...
                        <a href="javascript:void(0)" id="trigger_btn" data-value=""
                           ...
                           onclick="setCommission()">{{translate('Confirm')}}</a>
                    </div>
                </div>
            </div>
        </div>
