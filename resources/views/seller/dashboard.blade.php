                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                <g id="Group_38928" data-name="Group 38928" transform="translate(-9435 -1195)">
                                    <g id="Layer_2" data-name="Layer 2" transform="translate(9435 1195)">
                                        <g id="people">
                                            <rect id="Rectangle_23088" data-name="Rectangle 23088" width="16"
                                                  height="16" fill="#fff" opacity="0"/>
                                            <path id="Path_45108" data-name="Path 45108"
                                                  d="M6.667,8.333A2.667,2.667,0,1,0,4,5.667,2.667,2.667,0,0,0,6.667,8.333Zm0-4A1.333,1.333,0,1,1,5.333,5.667,1.333,1.333,0,0,1,6.667,4.333ZM12,9.667a2,2,0,1,0-2-2A2,2,0,0,0,12,9.667ZM12,7a.667.667,0,1,1-.667.667A.667.667,0,0,1,12,7Zm0,3.333a3.333,3.333,0,0,0-2.04.7A4.667,4.667,0,0,0,2,14.333a.667.667,0,1,0,1.333,0,3.333,3.333,0,0,1,6.667,0,.667.667,0,0,0,1.333,0A4.6,4.6,0,0,0,10.76,12.1,2,2,0,0,1,14,13.667a.667.667,0,1,0,1.333,0A3.333,3.333,0,0,0,12,10.333Z"
                                                  transform="translate(-0.667 -1)" fill="#fff"/>
                                        </g>
                                    </g>
                                </g>
                            </svg>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16.5" height="16.5" viewBox="0 0 16.5 16.5">
                                <g id="Group_38929" data-name="Group 38929" transform="translate(-10183 -1360.5)">
                                    ...
                                    <g id="Group_38926" data-name="Group 38926" transform="translate(10117.9 1317.63)">
                                        <line id="Line_315" data-name="Line 315" x2="4"
                                              transform="translate(77.1 45.37)" fill="none" stroke="#fff"
                                              stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
                                              stroke-width="1"/>
                                        <line id="Line_316" data-name="Line 316" y1="4"
                                              transform="translate(79.099 43.37)" fill="none" stroke="#fff"
                                              stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
                                              stroke-width="1"/>
                                    </g>
                                </g>
            ...
            <div class="card shadow-none mb-4 bg-primary ">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <a href="{{ route('seller.orders.index') }}">
                            <div class="d-flex align-items-center">
                                <p class="fs-12 text-light my-2 ml-1"> {{ translate('Last Month') }}
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if ($authUser->shop?->seller_package)
                            <div class="d-flex">
                                <div class="col-3">
                                    <img src="{{ get_file_by_id($authUser->shop->seller_package->logo) }}"
                            ...
                            @elseif(get_setting('seller_commission_type') == 'category_based')
                                <li class="d-flex justify-content-between align-items-center my-2 text-primary fs-13">
                                    ...
                                    <a class="btn btn-primary btn-xs "
                                       href="{{ route('seller.categories-wise-commission') }}">{{ translate('Details') }}</a>
                                </span>
                                </li>
                            @endif
                        </ul>
