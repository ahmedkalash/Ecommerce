                ...
                <div class="col-md-3 ml-auto mr-0">
                    <select class="form-control form-control-xs aiz-selectpicker" name="sort" onchange="sort_uploads()">
                        ...
                        <option value="smallest"
                                @if($sort_by == 'smallest') selected="" @endif>{{ translate('Sort by smallest') }}</option>
                        <option value="largest"
                                @if($sort_by == 'largest') selected="" @endif>{{ translate('Sort by largest') }}</option>
                    </select>
                </div>
                <div class="col-md-3">
                            ...
                            <div class="aiz-file-box">
                                <div class="dropdown-file">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{ get_file_by_path($file->file_name) }}" target="_blank"
                                ...
                                <div class="card card-file aiz-uploader-select c-default"
                                    ...
                                    <div class="card-file-thumb">
                                        @if($file->type == 'image')
                                            <img src="{{ get_file_by_path($file->file_name) }}" class="img-fit">
