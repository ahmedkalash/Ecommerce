            ...
            <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                <div class="card shadow-none rounded-0 border-0">
                    <div class="row no-gutters">
                        <!-- Left Side Image-->
                        <div class="col-lg-6">
                            <img src="{{ get_file_by_id(get_setting('forgot_password_page_image')) }}"
                        ...
                        <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center border right-content"
                            ...
                            <div class="text-center text-lg-left">
                                <h1 class="fs-20 fs-md-20 fw-700 text-primary"
                                    style="text-transform: uppercase;">{{ translate('Forgot password?') }}</h1>
                            ...
                            <div class="pt-3">
                                <div class="">
                                    <form class="form-default" id="forgot-pass-form" role="form"
                                        ...
                                        <div class="mb-4 mt-4">
                                            <button type="submit"
                                                    class="btn btn-primary btn-block fw-700 fs-14 rounded-0">{{ translate('Send Password Reset Code') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
