...
@if (addon_is_activated('otp_system'))
    <script type="text/javascript">
        ...
        // Auto-switch to email if there are errors in email field
        $(document).ready(function () {
            if ($('.email-form-group .is-invalid').length > 0) {
                isPhoneShown = false;
                ...
                var toggleBtn = $('button[onclick="toggleEmailPhone(this)"]');
                toggleBtn.html('*' + @json(translate('Use Phone Number Instead')));
        ...
        function toggleEmailPhone(el) {
            if (isPhoneShown) {
                ...
                $('input[name=phone]').val(null);
                isPhoneShown = false;
                $(el).html('*' + @json(translate('Use Phone Number Instead')));
                ...
                isPhoneShown = true;
                $(el).html('<i>*' + @json(translate('Use Email Instead')) +'</i>');
            ...
            $('.submit-button').html(@json(translate('Login')));
