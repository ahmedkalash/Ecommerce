                            ...
                            <div
                                ...
                                <div class="pt-3 pt-lg-4">
                                    <form id="reg-form" class="form-default" role="form"
                                        ...
                                        @csrf
                                        <input type="hidden" name="seller_verification_id"
                                               value="{{ $customerVerification->id }}">
                                        ...
                                        <div class="form-group">
                                            <label
                                                class="fs-12 fw-700 text-soft-dark">{{  translate('Verification Code') }}</label>
                                        ...
                                        <div class="mb-4 mt-4">
                                            <button type="submit"
                                                    class="btn btn-primary btn-block fw-600 rounded-0">{{  translate('Submit') }}</button>
                                        </div>
                                    </form>
                                    <!-- Log In -->
