                        ...
                        <div class="py-3 py-lg-4 px-3 px-xl-5 flex-grow-1">
                            ...
                            <div class="text-center text-lg-left">
                                <h1 class="fs-20 fs-md-20 fw-700 text-primary"
                                    style="text-transform: uppercase;">{{ translate('Reset Password') }}</h1>
                                    ...
                                    <form class="form-default" role="form" action="{{ route('password.update') }}"
                                        ...
                                        <div class="form-group">
                                            <input id="email" type="email"
                                                   ...
                                                   placeholder="{{ translate('Email') }}" required autofocus readonly>
                                        ...
                                        <div class="form-group">
                                            <input id="password" type="password"
                                                   ...
                                                   name="password" placeholder="{{ translate('New Password') }}"
                                                   required>
