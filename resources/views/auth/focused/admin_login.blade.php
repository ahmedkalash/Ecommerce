        ...
        <div class="row no-gutters" style="min-height: 100vh;">
            ...
            <div class="col-xxl-9 col-lg-8">
                <div class="h-100" style="max-height: 100vh">
                    <img src="{{ get_file_by_id(get_setting('admin_login_page_image')) }}" alt="" class="img-fit h-100">
                </div>
            </div>
                ...
                <div class="d-flex align-items-center right-content">
                    <div class="py-3 py-lg-4 px-3 px-xl-5 flex-grow-1">
                        ...
                        <div class="size-48px mb-3 mx-auto mx-lg-0">
                            <img src="{{ get_file_by_id(get_setting('site_icon')) }}" alt="{{ translate('Site Icon')}}"
                                 class="img-fit h-100">
                        </div>
                        <!-- Titles -->
                        <div class="text-center text-lg-left">
                            <h1 class="fs-20 fs-md-20 fw-700 text-primary"
                                style="text-transform: uppercase;">{{ translate('Welcome to') }} {{ env('APP_NAME') }}</h1>
                            <h5 class="fs-14 fw-400 text-dark">{{ translate('Login to your account')}}</h5>
                        </div>
                        <!-- Login form -->
                        <div class="pt-3 pt-lg-4">
                            <div class="">
                                <form class="form-default" id="login-form" role="form" action="{{ route('login') }}"
                                      method="POST">
                                    @csrf
