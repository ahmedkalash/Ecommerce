...
@section('content')
                            ...
                            <div class="carousel-box px-4 d-flex flex-column align-items-center">
                                <div class="size-80px overflow-hidden hov-scale-img">
                                    <a class="d-block" href="{{ route('products.category', $category->slug) }}">
                                        <img
                                            src="{{ isset($category->bannerImage->file_name) ? get_file_by_path($category->bannerImage->file_name) : static_asset('assets/img/placeholder.jpg') }}"
    ...
    <div class="home-banner-area mb-3"
         style="background-color: {{ get_setting('slider_section_bg_color', '#dedede') }}">
                                ...
                                <a href="{{ isset(json_decode($home_slider_links, true)[$key]) ? json_decode($home_slider_links, true)[$key] : '' }}">
                                    ...
                                    <div
                                        ...
                                        <img class="img-fit h-100 m-auto has-transition ls-is-cached lazyloaded"
                                             src="{{ $slider ? $slider->getUrl() : static_asset('assets/img/placeholder-large.jpg') }}"
                    ...
                    <div class="row no-gutters align-items-center border" style="background: {{ $flash_deal_bg }};">
                        ...
                        <div class="col-xxl-2 col-md-3 col-sm-4 col-5 h-150px h-md-200px h-lg-240px">
                            <a href="{{ route('flash-deal-details', $flash_deal->slug) }}">
                                <div class="h-100 w-100 w-xl-auto"
                                     style="background-image: url('{{ get_file_by_id($flash_deal->banner) }}'); background-size: cover; background-position: center center;">
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-xxl-10 col-md-9 col-sm-8 col-7">
                            ...
                            <div class="aiz-carousel arrow-inactive-none arrow-x-0"
                                 data-items="6" data-xxl-items="6" data-xl-items="5" data-lg-items="3.7"
                                 data-md-items="3"
                                ...
                                <a href="{{ isset(json_decode($home_preorder_banner_1_links, true)[$key]) ? json_decode($home_preorder_banner_1_links, true)[$key] : '' }}"
                                   class="d-block text-reset overflow-hidden">
                                    <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                         data-src="{{ get_file_by_id($value) }}" alt="{{ env('APP_NAME') }} promo"
                        ...
                        <div class="col mb-2 mb-md-3 mt-2 mt-md-3">
                            <div class="h-100" id="section_top_sellers">
                                <div class="border px-3 py-2rem">
                                    ...
                                    <!-- Sellers Section -->
                                    <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-rows="{{ $data_rows }}"
                                         data-items="{{ $xxl_items }}" data-xxl-items="{{ $xxl_items }}"
                                         data-xl-items="{{ $xl_items }}" data-lg-items="{{ $lg_items }}"
                                         data-md-items="{{ $md_items }}" data-sm-items="2" data-xs-items="1.4"
                                                            ...
                                                            <a href="{{ route('shop.visit', $seller->slug) }}"
                                                               ...
                                                               style="border: 1px solid #e5e5e5; border-radius: 50%; box-shadow: 0px 10px 20px rgba(0, 0, 0, 0.06);">
                                                                <img
                                                                    ...
                                                                    data-src="{{ get_file_by_id($seller->logo) }}"
                                                                    alt="{{ $seller->name }}"
                        ...
                        <div class="h-100" id="section_top_brands">
                            <div class="border px-3 pt-3">
                                ...
                                <div class="aiz-carousel arrow-x-0 arrow-inactive-none py-4"
                                     ...
                                     data-xl-items="{{ $xl_items }}" data-lg-items="{{ $lg_items }}"
                                     data-md-items="{{ $md_items }}" data-sm-items="{{ $sm_items }}"
                            ...
                            <div class="order-lg-1 mb-3 mb-lg-0">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <g id="Group_24326" data-name="Group 24326"
                                       transform="translate(-274.202 -5254.612)" opacity="0.5">
                                        ...
                                        <div class="w-sm-270px h-320px mx-auto">
                                            <a href="{{ route('customer.products') }}"
                                               class="d-block h-100 w-100 w-xl-auto hov-scale-img overflow-hidden">
                                                <img src="{{ get_file_by_id($classifiedBannerImage) }}"
                                                    ...
                                                    <a href="{{ route('customer.product', $classified_product->slug) }}"
                                                       class="d-block overflow-hidden h-140px h-md-170px text-center hov-scale-img mb-3">
                                                        <img class="img-fluid lazyload mx-auto has-transition"
                                                             ...
                                                             data-src="{{ isset($classified_product->thumbnail->file_name) ? get_file_by_path($classified_product->thumbnail->file_name) : static_asset('assets/img/placeholder.jpg') }}"
