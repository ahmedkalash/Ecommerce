    ...
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            ...
            <div class="row no-gutters">
                    ...
                    <div class="col-xl-5">
                        <div class="overflow-hidden h-100 d-none d-md-block">
                            <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                 data-src="{{ get_file_by_id($todays_deal_banner) }}"
                                 alt="{{ env('APP_NAME') }} promo" class="lazyload img-fit h-100 has-transition"
                                 onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
                        </div>
                        <div class="overflow-hidden h-100 d-md-none">
                            <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                 data-src="{{ $todays_deal_banner_small != null ? get_file_by_id($todays_deal_banner_small) : get_file_by_id($todays_deal_banner) }}"
                                 alt="{{ env('APP_NAME') }} promo" class="lazyload img-fit h-100 has-transition"
                                 onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
                        </div>
                    </div>
                ...
                @endphp
                <div class="{{ $col_val }}"
                     style="background-color: {{ get_setting('todays_deal_bg_color', '#3d4666') }}">
                    ...
                    <div class="c-scrollbar-light overflow-hidden px-4 px-md-5 pb-3 pt-3 pt-md-3 pb-md-5">
                        <div class="h-100 d-flex flex-column justify-content-center">
                            <div class="todays-deal aiz-carousel" data-items="{{ $xxl_items }}"
                                 data-xxl-items="{{ $xxl_items }}" data-xl-items="{{ $xxl_items }}" data-lg-items="5"
                                 data-md-items="4" data-sm-items="3" data-xs-items="2" data-arrows="true"
