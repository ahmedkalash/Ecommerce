                ...
                <div class="pt-4 pb-lg-4">
                    <div class="container">
                        <div class="w-100 px-3 px-lg-0">
                            <div
                                class="aiz-carousel gutters-16 overflow-hidden arrow-inactive-none arrow-dark arrow-x-15"
                                    ...
                                    <a href="{{ route('flash-deals') }}"
                                       class="d-block text-reset overflow-hidden position-relative">
                                        <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                             data-src="{{ get_file_by_id(get_setting('flash_deal_card_bg_image', null, $lang)) }}"
                                             alt="{{ env('APP_NAME') }} promo"
                                ...
                                <div class="carousel-box overflow-hidden hov-scale-img">
                                    <a href="{{ route('todays-deal') }}"
                                       class="d-block text-reset overflow-hidden position-relative">
                                        <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                             data-src="{{ get_file_by_id(get_setting('todays_deal_card_bg_image', null, $lang)) }}"
                                             alt="{{ env('APP_NAME') }} promo"
                                             class="img-fluid lazyload w-100 has-transition"
                                             onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
                                        <span class="position-absolute top-0 left-0 p-2rem d-flex flex-column"
                                ...
                                <div class="carousel-box overflow-hidden hov-scale-img">
                                    <a href="{{ route('search',['sort_by'=>'newest']) }}"
                                       class="d-block text-reset overflow-hidden position-relative">
                                        <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                             data-src="{{ get_file_by_id(get_setting('new_product_card_bg_image', null, $lang)) }}"
                                             alt="{{ env('APP_NAME') }} promo"
                                             class="img-fluid lazyload w-100 has-transition"
                                             onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
                                        <span class="position-absolute top-0 left-0 p-2rem d-flex flex-column"
                            ...
                            <div
                                ...
                                <div class="h-200px h-sm-250px h-md-340px">
                                    <div class="h-100 w-100 w-xl-auto position-relative hov-scale-img overflow-hidden">
                                        ...
                                        <div
                                            class="absolute-bottom-left has-transition h-80px w-100 d-flex flex-column align-items-center justify-content-center"
                ...
                <div class="container">
                    ...
                    @if (get_setting('classified_banner_image') != null || get_setting('classified_banner_image_small') != null)
                        <div class="overflow-hidden hov-scale-img d-none d-md-block">
                            <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                 data-src="{{ get_file_by_id($classifiedBannerImage) }}"
                                 alt="{{ env('APP_NAME') }} promo" class="lazyload img-fit h-100 has-transition"
                                 onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
                        </div>
                        <div class="overflow-hidden hov-scale-img d-md-none">
                            <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                 data-src="{{ $classifiedBannerImageSmall != null ? get_file_by_id($classifiedBannerImageSmall) : get_file_by_id($classifiedBannerImage) }}"
                                 alt="{{ env('APP_NAME') }} promo" class="lazyload img-fit h-100 has-transition"
                                 onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
                        </div>
                    @endif
                    ...
                    <section class="mt-2 mt-md-3 border h-100">
                        <div class="p-4">
                            ...
                            <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-rows="3" data-items="3"
                                 data-xxl-items="3"
                                 data-xl-items="3" data-lg-items="4" data-md-items="3" data-sm-items="2"
                                 data-xs-items="1.4"
                                 data-arrows="true" data-dots="false">
                                @php
