        ...
        <div class="row">
            <div class="col-lg-8">
                @if(auth()->check())
                    ...
                    @if($welcomeCoupon)
                        <div
                            class="alert alert-primary align-items-center border d-flex flex-wrap justify-content-between rounded-0"
                            ...
                            <div class="fw-400 fs-14" style="color: #3490F3 !important;">
                                ...
                                <strong>{{ $discount }}</strong> {{ translate('Discount on your Purchase Within') }}
                                <strong>{{ $welcomeCoupon->validation_days }}</strong> {{ translate('days of Registration') }}
                            </div>
                                    ...
                                    <li class="list-group-item px-0 border-md-0">
                                        <div class="row gutters-5 align-items-center">
                                            ...
                                            <div class="col-md-5 col-10 d-flex align-items-center mb-2 mb-md-0">
                                                ...
                                                <span>
                                                    ...
                                                    @if ($admin_product_variation[$key] != '')
                                                        <span
                                                            class="fs-12 text-secondary">{{ translate('Variation') }}: {{ $admin_product_variation[$key] }}</span>
                                                    @endif
                                                </span>
                                            </div>
                                            <!-- Price & Tax -->
                                            <div
                                                ...
                                                <span>
                                                    <span
                                                        class="opacity-90 fs-12">{{ translate('Tax')}}: {{ cart_product_tax($cartItem, $product) }}</span>
                                                </span>
                                            </div>
                                            <!-- Quantity & Total -->
                                            <div
                                                ...
                                                <div>
                                                    @if ($product->digital != 1 && $product->auction_product == 0)
                                                        <div
                                                            class="d-flex flex-xl-column flex-xxl-row align-items-center aiz-plus-minus mr-0 ml-0"
