...
<a href="javascript:void(0)" class="d-flex align-items-center px-3 h-100" data-toggle="dropdown" data-display="static"
   title="{{translate('Cart')}}">
    ...
    <span
        class="d-none d-xl-block ml-2 fs-14 fw-700 {{ get_setting('header_element') !=5 ? 'bottom-text-color-visibility' : 'middle-text-color-visibility' }}"
    ...
    <span
        class="nav-box-text d-none d-xl-block ml-2 fs-12 {{ get_setting('header_element') !=5 ? 'bottom-text-color-visibility' : 'middle-text-color-visibility' }}"
        style="color: {{ get_setting('header_element') !=5 ? get_setting('bottom_header_text_color'): get_setting('middle_header_text_color') }}">
