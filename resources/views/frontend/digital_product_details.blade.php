                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="text-md-right mt-1">
                                        <a href="#"
                                           class="text-blue hov-text-primary fs-14">{{ translate('Ask about this product') }}</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                <button type="button"
                                        class="btn btn-secondary-base mr-2 add-to-cart fw-600 w-150px rounded-0 text-white"
                                ...
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="{{ route('returnpolicy') }}"
                                           class="text-blue hov-text-primary fs-14 ml-2"
                        ...
                        <div class="border mb-4" style="background: #fcfcfd;">
                            <div class="position-relative p-4 text-left">
                                ...
                                <div class="d-flex mt-1">
                                    ...
                                    <div>
                                        <a href="{{ route('shop.visit', $detailedProduct->user->shop->slug) }}"
                                           class="text-reset d-block fw-700">
                        ...
                        <div class="bg-white border mt-4">
                            ...
                            <textarea class="form-control rounded-0" rows="3" cols="40" name="question"
                                      ...
                                      style="resize: none;"></textarea>
                                        ...
                                        <button type="submit"
                                                class="btn btn-sm w-150px btn-primary rounded-0">{{ translate('Submit') }}</button>
                                    </form>
                                </div>
