        ...
        <div class="col-md-4 mx-auto mb-4">
            <div class="text-center bg-light d-block p-4 h-100 border">
                @if($customer_package != null)
                    <img src="{{ get_file_by_id($customer_package->logo) }}" height="44" class="mw-100 mx-auto mb-2">
                    <span
                        class="d-block text-dark fs-14 fw-600 mb-2">{{ translate('Current Package')}}: {{ $customer_package->getTranslation('name') }}</span>
                @else
