            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="p-4 border h-100">
                    ...
                    @if($customer_package != null)
                        <img src="{{ get_file_by_id($customer_package->logo) }}" class="img-fluid mb-4 h-70px"
                ...
                @if(Auth::user()->addresses != null)
                    ...
                    @if($address != null)
                        <ul class="list-unstyled mb-5">
                            ...
                            <li class="fs-14 fw-400 text-derk pb-1"><span>{{ $address->postal_code }} - {{ $address->city->name }},</span>
                            </li>
