            ...
            @foreach(get_all_manual_payment_methods() as $method)
                <div class="col-6 col-md-4">
                    <label class="aiz-megabox d-block mb-3">
                        ...
                        <img src="{{ get_file_by_id($method->photo) }}" class="img-fluid mb-2">
        ...
        <div id="manual_payment_data">
            ...
            <div class="card rounded-0 shadow-none border mb-3 p-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-9">
                        <input type="number" lang="en" class="form-control mb-3 rounded-0" min="0" step="0.01"
                               name="amount" placeholder="{{ translate('Amount') }}" required>
                    </div>
                </div>
                <!-- Transaction ID -->
                <div class="row">
