...
@section('content')
    ...
    <div class="h-100 bg-cover bg-center py-5 d-flex align-items-center"
         style="background-image: url({{ get_file_by_id(get_setting('delivery_boy_login_page_bg')) }})">
        <div class="container">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="mb-5 text-center">
                                @if(get_setting('system_logo_black') != null)
                                    <img src="{{ get_file_by_id(get_setting('system_logo_black')) }}"
                            ...
                            <form class="pad-hor" id="deliveryboy-login-form" method="POST" role="form"
                                  action="{{ route('login') }}">
                                @csrf
                                <!-- Email or Phone -->
                                <div class="form-group">
                                    ...
                                    <input type="email"
                                           ...
                                           value="{{ old('email') }}"
                                           placeholder="{{  translate('johndoe@example.com') }}" name="email" id="email"
                                           autocomplete="off">
                                    @if ($errors->has('email'))
