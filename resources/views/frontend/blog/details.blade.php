...
@section('meta')
    ...
    <meta itemprop="image" content="{{ get_file_by_id($blog->meta_img) }}">
    ...
    <meta name="twitter:image" content="{{ get_file_by_id($blog->meta_img) }}">

    <!-- Open Graph data -->
    <meta property="og:title" content="{{ $blog->meta_title }}"/>
    <meta property="og:type" content="website"/>
    <meta property="og:url" content="{{ route('blog.details', $blog->slug) }}"/>
    <meta property="og:image" content="{{ get_file_by_id($blog->meta_img) }}"/>
                ...
                <div class="col-xxl-7 col-lg-8">
                    <div class="mb-4">
                        ...
                        <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                             data-src="{{ get_file_by_id($blog->banner) }}"
                             alt="{{ $blog->title }}"
                                        ...
                                        <div class="">
                                            <a href="{{ url("blog").'/'. $recent_blog->slug }}"
                                               class="text-reset d-block overflow-hidden size-80px size-xl-90px mr-2">
                                                <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                                     data-src="{{ get_file_by_id($recent_blog->banner) }}"
