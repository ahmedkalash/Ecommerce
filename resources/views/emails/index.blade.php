                ...
                <tr>
                    <td align="center">
                        <table width="650" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td bgcolor="#ffffff"
                                    style="width:650px; min-width:650px; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                    <!-- Header -->
                                                    ...
                                                    <tr>
                                                        <th style="line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                                            <table width="100%" border="0" cellspacing="0"
                                                                   cellpadding="0">
                                                                <tr>
                                                                    <td style="line-height:0pt; text-align:left;"><img
                                                                            src="{{ get_file_by_id($logo) }}"
                                                                            width="" height="26" border="0" alt=""/>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                        <th width="170"
                                                            style="line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                                            <table width="100%" border="0" cellspacing="0"
                                                                   cellpadding="0">
                                                                <tr>
                                                                    <td style="color:#000000; font-family:'Public Sans', sans-serif; font-size:14px; line-height:16px; text-align:right;">
                                                                        <a href="{{ env('APP_URL') }}" target="_blank"
                                                                           style="color:#000001; text-decoration:none; font-weight: 500">
                                                                            <span
