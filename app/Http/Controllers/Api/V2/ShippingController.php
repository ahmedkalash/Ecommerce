...
class ShippingController extends Controller
{
    ...
    public function shipping_cost(Request $request)
    {
        ...
        $main_carts = ($userId != null) ? Cart::where('user_id', $userId)->active()->get() : Cart::where('temp_user_id',
        ...
        return response()->json([
            'result' => true, 'shipping_type' => get_setting('shipping_type'),
    ...
    public function getDeliveryInfo(Request $request)
    {
        ...
        $cartItems = ($userId != null) ? Cart::where('user_id', $userId)->active() : Cart::where('temp_user_id',
            $tempUserId)->active();
        ...
        $owner_ids = ($userId != null) ?
            Cart::where('user_id',
                $userId)->active()->select('owner_id')->groupBy('owner_id')->pluck('owner_id')->toArray() :
            Cart::where('temp_user_id',
                $tempUserId)->active()->select('owner_id')->groupBy('owner_id')->pluck('owner_id')->toArray();
        $shops = [];
        if (! empty($owner_ids)) {
