    ...
    public function callback(Request $request)
    {
        ...
        if ($payWithIyzico->getStatus() == 'success') {
            return response()->json([
                'result' => true, 'message' => translate('Payment is successful'), 'payment_details' => $payment,
            ]);
        } else {
            return response()->json([
                'result' => false, 'message' => translate('Payment unsuccessful'), 'payment_details' => $payment,
            ]);
        }
    }
