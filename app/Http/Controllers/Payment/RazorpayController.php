        ...
        if (Session::has('payment_type')) {
            ...
            if ($paymentType == 'cart_payment') {
                ...
                $res = $api->order->create([
                    'receipt' => '123', 'amount' => round($combined_order->grand_total) * 100, 'currency' => 'INR',
                ...
                $res = $api->order->create([
                    'receipt' => '123', 'amount' => $order->amount * 100, 'currency' => 'INR',
                    'notes' => ['key1' => 'value3', 'key2' => 'value2'],
                ]);
                ...
                $res = $api->order->create([
                    'receipt' => '123', 'amount' => $paymentData['amount'] * 100, 'currency' => 'INR',
                    'notes' => ['key1' => 'value3', 'key2' => 'value2'],
                ]);
                ...
                $res = $api->order->create([
                    'receipt' => '123', 'amount' => $customer_package->amount * 100, 'currency' => 'INR',
                    'notes' => ['key1' => 'value3', 'key2' => 'value2'],
                ]);
                ...
                $res = $api->order->create([
                    'receipt' => '123', 'amount' => $seller_package->amount * 100, 'currency' => 'INR',
                    'notes' => ['key1' => 'value3', 'key2' => 'value2'],
                ]);
