...
class NgeniusController extends Controller
{
    public function pay()
    {
        ...
        if ($paymentType == 'cart_payment') {
            ...
            // will be redirected
            NgeniusUtility::make_payment(route('ngenius.customer_package_payment_callback'), 'customer_package_payment',
                $amount);
            ...
            // will be redirected
            NgeniusUtility::make_payment(route('ngenius.seller_package_payment_callback'), 'seller_package_payment',
                $amount);
        }
