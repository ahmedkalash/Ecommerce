...
class NgeniusUtility
{
    ...
    public static function getAccessToken()
    {
        ...
        $tokenResponse = self::invokeCurlRequest('POST', $idServiceURL, $tokenHeaders,
    ...
    public static function make_payment($callback_url, $payment_type, $amount)
    {
        ...
        $order->amount->currencyCode = env('NGENIUS_CURRENCY',
            'AED');                           // Payment currency ('AED' only for now)
        ...
        $orderCreateHeaders = [
            'Authorization: Bearer '.$access_token, 'Content-Type: application/vnd.ni-payment.v2+json',
